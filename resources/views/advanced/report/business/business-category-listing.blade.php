...
<div class="content">
  ...
  <div id="card">
    ...
    <div class="row" style="border-bottom: 2px solid black;">
      <h4 style="text-align: center; font-size: 14px; color: black; font-weight: 600;">Business Listing Grouped by Business <?= ucwords($location); ?> for <?= ucwords($year); ?></h4>
    </div>
  <table id="fBill1" class="display" cellspacing="0" width="100%">
      <thead>
          <tr>
            <th></th>
            <th style="font-size: 11px;color: black;">Business <?= ucwords($location); ?></th>
      ...
      <tbody>
          ...
          <div class="tableInner">
            <tr class="odd2 heyy">
                <td>
                  <a href="{{route('advanced.report.business.details', ['category', $electoral->code, $year])}}"><img src="/advanced/1/add-square-button.png"></a>
                </td>
                <td>
                  <a style="color:blue; font-weight: 400;" href="{{route('advanced.report.business.details', ['category', $electoral->code, $year])}}">
