  ...
  <table id="fBill1" class="display" cellspacing="0" width="100%">
      ...
      <tbody>
          ...
          <div class="tableInner">
            <tr class="odd2 heyy">
                <td>
                  <a href="{{route('advanced.report.business.details', ['zonal', $electoral->code, $year])}}"><img src="/advanced/1/add-square-button.png"></a>
                </td>
                <td>
                  <a style="color:blue; font-weight: 400;" href="{{route('advanced.report.business.details', ['zonal', $electoral->code, $year])}}">
