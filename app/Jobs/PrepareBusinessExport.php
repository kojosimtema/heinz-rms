...
class PrepareBusinessExport implements ShouldQueue
{
    ...
    //   (new NorminalRowExportBusiness($this->year, $this->electoral, $this->type))->queue($this->name);
      $gt = Excel::raw(new NorminalRowExportBusiness($this->year, $this->electoral, $this->type), \Maatwebsite\Excel\Excel::XLSX);
      \App\TemporalFiles::create(['file' => $gt, 'filename' => $this->name]);
